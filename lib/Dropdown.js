...
var propTypes = {
   ...
   * @controllable onToggle
   */
  closeOnTab: _react2['default'].PropTypes.bool,
...
var Dropdown = function (_React$Component) {
  ...
  Dropdown.prototype.handleKeyDown = function handleKeyDown(event) {
    ...
    switch (event.keyCode) {
      ...
      case _keycode2['default'].codes.tab:
        this.props.closeOnTab ? this.handleClose(event) : undefined;
        break;
      default:
    }
  };
  ...
  Dropdown.prototype.renderMenu = function renderMenu(child, _ref) {
    ...
    var id = _ref.id,
        ...
        props = (0, _objectWithoutProperties3['default'])(_ref, ['id', 'onClose', 'onSelect', 'rootCloseEvent', 'closeOnSelect']);
    ...
    return (0, _react.cloneElement)(child, (0, _extends3['default'])({}, props, {
      ...
      onSelect: (0, _createChainedFunction2['default'])(child.props.onSelect, onSelect, closeOnSelect ? this.handleClose : undefined),
  ...
  Dropdown.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        props = (0, _objectWithoutProperties3['default'])(_props, ['componentClass', 'id', 'dropup', 'disabled', 'pullRight', 'open', 'onClose', 'onSelect', 'closeOnSelect', 'role', 'bsClass', 'className', 'rootCloseEvent', 'children']);
        ...
        switch (child.props.bsRole) {
          ...
          case MENU_ROLE:
            return _this4.renderMenu(child, {
              id: id, open: open, pullRight: pullRight, bsClass: bsClass, onClose: onClose, onSelect: onSelect, closeOnSelect: closeOnSelect, rootCloseEvent: rootCloseEvent
            });
          default:
            return child;
        }
